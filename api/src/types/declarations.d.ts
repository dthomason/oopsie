...
export declare const RegionList: readonly [
  'Africa',
  'Americas',
  'Antarctic',
  'Asia',
...
export declare const SubregionList: readonly [
  'Southern Asia',
  'Southern Europe',
  'Northern Africa',
  'Polynesia',
...
export declare const TranslationLanguageCodeList: readonly [
  'common',
  'cym',
  'deu',
  'fra',
...
export declare type TranslationLanguageCode =
...
export declare type PromiseWithOptions<T> = T & {
  resolve: (value: any) => void;
